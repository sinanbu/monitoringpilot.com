<%@ Page Language="C#" AutoEventWireup="true" CodeFile="survey2.aspx.cs" Inherits="survey2" EnableEventValidation="false" %>
...
<tr><td style="text-align:left; width:100% ;" colspan="2"><span style="font-family:'Trebuchet MS'; color:#222; font-size:medium; margin:0; ">
    ...
    <td style="text-align:left; width:7% ;"><img src="images/Survey100.jpg" /></td> 
        <td style="text-align:left; vertical-align:top; width:93% ;"><span style="font-family:'Trebuchet MS'; vertical-align:top; color:#222; margin:0; ">
            Çalışma ve iş verimliliğini arttırmak için ve ayrıca pilotların vardiya günü istasyonlara geliş yollarındaki zaman kayıplarının 
            önlenmesi amacıyla gerekirse Vardiya Giriş-Çıkış saatinin değiştirilmesi hedeflenmektedir. Bu sebeple 
            Şirketimiz vardiya değişim saati konusunda pilotların görüşünü alacaktır. Seçiminizi yapmak için

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YalovaShips.aspx.cs" Inherits="YalovaShips" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
    <title>MonitoringPilot - Yalova Ships</title>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <table style="width: 1340px; height: 25px; color: white;">
                            <tr>
                                <td style="text-align: left;">
                                    ...
                                    <button runat="server" id="Byalovaships" style="border: 1px solid black; background-color: #9FF3A1; height: 25px; Width: 90px; font-size: 11px; text-align: center;" >Yalova Ships</button>&nbsp;
                      ...
                      <button runat="server" id="ButtonANJ" style="border: 1px solid black; cursor: pointer; background-color: #ee1111; height: 25px; Width: 90px; font-size: 11px; text-align: center;" onclick="window.location.href='newjob.aspx'">Add New Job</button>&nbsp;&nbsp;
                                ...
                                <ItemTemplate>
                                    <tr id="Row" runat="server" class="trsatir2 rowflash" style="background-color:#ffffd0">
                                        ...
                                        <td class="tdis2 "  id="warngemitd">
                                            <asp:Button ID="LBpata1c" OnClick="LBpata_Click"  runat="server" CssClass="butongemi2" Text='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' ></asp:Button>
                                        ...
                                        <td class="tdis3 ">
                                            <asp:Label ID="Lbl3" runat="server"><%#Eval("kalkislimani") %> <%#Eval("kalkisrihtimi") as string == "0" || Eval("kalkisrihtimi") as string == ""  ? "" : "/" + Eval("kalkisrihtimi")   %> </asp:Label><asp:Label ID="Lbl3rg" runat="server" Visible="false" Text='<%#Eval("kalkisrihtimi")%>'></asp:Label></td>
                                         <td class="tdis4 ">
                                            <asp:Label ID="Lbl5" runat="server" Text='<%#Eval("yanasmalimani") %>'></asp:Label><asp:Label ID="Lbl5r" runat="server" Text='<%#Eval("yanasmarihtimi") as string == "0" || Eval("yanasmarihtimi") as string == ""  ? "" : "/" + Eval("yanasmarihtimi")   %>'></asp:Label><asp:Label ID="Lbl5rg" runat="server" Visible="false" Text='<%#Eval("yanasmarihtimi")%>'></asp:Label></td>
                                        <td class="tdis5">
                                        ...
                                        <td class="tdis17 ">
                                            <asp:Label ID="Lbl20" runat="server" Text='<%#Eval("talepno").ToString().Length>6? (Eval("talepno") as string).Substring(0,7)+"." : Eval("talepno")%>' ToolTip='<%#Eval("talepno") %>'></asp:Label></td>
                                        <td class="tdis18 ">
                                            <asp:ImageButton ID="Ibje1" CommandName='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' runat="server" ImageUrl="~/images/edit.png" Width="16px" OnClick="ImageButtonJobEdit_Click" />
                        ...
                        <asp:Label  runat="server" CssClass="tablobaslik2" Text="YALOVA PORTS"></asp:Label>
                        <asp:Panel ID="panelcollapseyalport" Style="display: block; overflow: hidden;" runat="server">
                            <asp:Repeater ID="DLyalportShipList" runat="server" OnItemDataBound="DLyalportShipList_ItemDataBound">
                                <HeaderTemplate>
                                    <table class="tablo2">
                                        <tr class="trbaslik2">
                                ...
                                <ItemTemplate>
                                    <tr id="RowDLyalportShipList" runat="server" class="trsatir2 rowflash">
                                        <td class="tdis1 ">
                                        ...
                                        <td class="tdis2 " id="warngemitd">
                                            <asp:Button ID="LBpata2" OnClick="LBpata_Click" runat="server"  CssClass="butongemi2" Text='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' ></asp:Button></td>
                                        <td class="tdis16 " id="warntd">
                                            <asp:Label ID="notlar" runat="server" Text='<%#Eval("notlar").ToString().Length>33? (Eval("notlar") as string).Substring(0,34)+"." : Eval("notlar")%>' ToolTip='<%#Eval("notlar") %>'></asp:Label><asp:Label ID="notlar2" runat="server" Text='<%#Eval("notlar")%>' Visible="false"></asp:Label></td>
                                        
                                        <td class="tdis3 ">
                                            <asp:Label ID="Lbl3" runat="server"><%#Eval("kalkislimani") %> </asp:Label></td>
                                        <td class="tdis4 ">
                                        ...
                                        <td class="tdis17 ">
                                            <asp:Label ID="Lbl20" runat="server" Text='<%#Eval("talepno").ToString().Length>6? (Eval("talepno") as string).Substring(0,7)+"." : Eval("talepno")%>' ToolTip='<%#Eval("talepno") %>'></asp:Label></td>
                                        <td class="tdis18 ">
                                            <asp:ImageButton ID="Ibje2" CommandName='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' runat="server" ImageUrl="~/images/edit.png" Width="16px" OnClick="ImageButtonJobEdit_Click" />
                                          <asp:Label Font-Size="8px" ID="Lblkaydeden" runat="server" Text='<%#Eval("kaydeden")%>'></asp:Label>
                                        </td>
                        ...
                        <asp:Label  runat="server" CssClass="tablobaslik2" Text="YALOVA ANCHORAGE"></asp:Label>
                                ...
                                <ItemTemplate>
                                    <tr id="RowDLAnchoredShipList" runat="server" class="trsatir2 rowflash">
                                        <td class="tdis1 ">
                                            <asp:Label ID="LBshipgec2" runat="server" Font-Bold="true" ForeColor="Red" Text='<%# Container.ItemIndex +1 %>'></asp:Label><asp:LinkButton ID="LBpatashiphis2" runat="server" Font-Bold="true" Style="cursor: pointer; text-decoration: none;" Visible="false"> <%#Eval("id")%> </asp:LinkButton></td>
                                        <td class="tdis2 " id="warngemitd">
                                            <asp:Button ID="LBpata3" OnClick="LBpata_Click" runat="server"  CssClass="butongemi2" Text='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' ></asp:Button></td>
                                        <td class="tdis16 " id="warntd">
                                            <asp:Label ID="notlar" runat="server" Text='<%#Eval("notlar").ToString().Length>33? (Eval("notlar") as string).Substring(0,34)+"." : Eval("notlar")%>' ToolTip='<%#Eval("notlar") %>'></asp:Label><asp:Label ID="notlar2" runat="server" Text='<%#Eval("notlar")%>' Visible="false"></asp:Label></td>
                                        ...
                                        <td class="tdis17 ">
                                            <asp:Label ID="Lbl20" runat="server" Text='<%#Eval("talepno").ToString().Length>6? (Eval("talepno") as string).Substring(0,7)+"." : Eval("talepno")%>' ToolTip='<%#Eval("talepno") %>'></asp:Label></td>
                                        <td class="tdis18 ">
                                            <asp:ImageButton ID="Ibje3" CommandName='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' runat="server" ImageUrl="~/images/edit.png" Width="16px" OnClick="ImageButtonJobEdit_Click" />
                                          <asp:Label Font-Size="8px" ID="Lblkaydeden" runat="server" Text='<%#Eval("kaydeden")%>'></asp:Label>
                                        </td>
                        ...
                        <asp:Label  runat="server" CssClass="tablobaslik2" Text="SHIPYARD VESSELS"></asp:Label>
                        <asp:Panel ID="panelcollapseyalova" Style="display: block; overflow: hidden;" runat="server">
                            <asp:Repeater ID="DLVIPortTers" runat="server" OnItemDataBound="DLVIPortTers_ItemDataBound">
                                ...
                                <ItemTemplate>
                                    <tr id="RowDLVIPortTers" runat="server" class="trsatir2 rowflash">
                                        <td class="tdis1">
                                            <asp:Label ID="LBshipgec4" runat="server" ForeColor="Red" Font-Bold="true" Text='<%# Container.ItemIndex +1 %>'></asp:Label><asp:LinkButton ID="LBpatashiphis4" runat="server" Style="cursor: pointer; text-decoration: none;" Font-Bold="true" Visible="false"> <%#Eval("id")%> </asp:LinkButton></td>
                                        <td class="tdis2" id="warngemitd">
                                            <asp:Button ID="LBpata4" OnClick="LBpata_Click" runat="server"  CssClass="butongemi2" Text='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' ></asp:Button></td>
                                        <td class="tdis16" id="warntd">
                                            <asp:Label ID="notlar" runat="server" Text='<%#Eval("notlar").ToString().Length>33? (Eval("notlar") as string).Substring(0,34)+"." : Eval("notlar")%>' ToolTip='<%#Eval("notlar") %>'></asp:Label><asp:Label ID="notlar2" runat="server" Text='<%#Eval("notlar")%>' Visible="false"></asp:Label></td>
                                        
                                        <td class="tdis3">
                                            <asp:Label ID="Lbl3" runat="server" Text='<%#Eval("kalkislimani") %>'></asp:Label><asp:Label ID="Lbl3r" runat="server" Text='<%#Eval("kalkisrihtimi") as string == "0" || Eval("kalkisrihtimi") as string == ""  ? "" : "/" + Eval("kalkisrihtimi")   %>'></asp:Label><asp:Label ID="Lbl3rg" runat="server" Visible="false" Text='<%#Eval("kalkisrihtimi")%>'></asp:Label></td>
                                        <td class="tdis4">
                                            <asp:Label ID="Lbl5" runat="server" Text='<%#Eval("yanasmalimani") %>'></asp:Label><asp:Label ID="Lbl5r" runat="server" Text='<%#Eval("yanasmarihtimi") as string == "0" || Eval("yanasmarihtimi") as string == ""  ? "" : "/" + Eval("yanasmarihtimi")   %>'></asp:Label><asp:Label ID="Lbl5rg" runat="server" Visible="false" Text='<%#Eval("yanasmarihtimi")%>'></asp:Label></td>                                        
                                        <td class="tdis5">
                                            <asp:Label ID="demirkisa" runat="server" Text='<%#Eval("demiryeri") %>'></asp:Label></td>                                         
                                        ...
                                        <td class="tdis17">
                                            <asp:Label ID="Lbl20" runat="server" Text='<%#Eval("talepno").ToString().Length>6? (Eval("talepno") as string).Substring(0,7)+"." : Eval("talepno")%>' ToolTip='<%#Eval("talepno") %>'></asp:Label></td>
                                        <td class="tdis18">
                                            <asp:ImageButton ID="Ibje4" CommandName='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' runat="server" ImageUrl="~/images/edit.png" Width="16px" OnClick="ImageButtonJobEdit_Click" />
                                           <asp:Label Font-Size="8px" ID="Lblkaydeden" runat="server" Text='<%#Eval("kaydeden")%>'></asp:Label>
                                        </td>
                            ...
                            <table class="panelpilotata">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Label ID="Lblpatailkkayit" Visible="false" runat="server" Text='<%#Eval("kayitzamani")%>'></asp:Label></td>
                                </tr>
                                ...
                                <table>
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                                <asp:Label  ID="LBJEimo" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="panel-style1">Ship Name :</td>
                                        <td>
                                               <asp:Label  ID="LBJEsn" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:Label  ID="LblDDLJEdepp" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td class="panel-style1">Departure Berth :</td>
                                        <td>
                                           <asp:Label  ID="LblJEdepb" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="panel-style1">Loa :</td>
                                        <td>
                                            <asp:TextBox CssClass="textboxs" ID="TBJEloa" runat="server" Visible="True" MaxLength="3" Width="65px" Height="16px"></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender10" TargetControlID="TBJEloa" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                        m.</td>
                                    </tr>
                                    <tr>
                                        <td class="panel-style1">Tug :</td>
                                        <td>
                                            <asp:TextBox CssClass="textboxs" ID="TBJEdrft" runat="server" Text="" MaxLength="1" Visible="True" Width="65px" Height="16px"></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender12" TargetControlID="TBJEdrft" runat="server"  FilterType="Custom" ValidChars="012345"></asp:FilteredTextBoxExtender>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox CssClass="ilkharfbuyuk" ID="TBJEagency" runat="server" Text="" MaxLength="40" Visible="True" Width="200px" Height="16px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="panel-style1">Invoice :</td>
                                        <td>
                                            <asp:TextBox CssClass="ilkharfbuyuk" ID="TBJEinvoice" runat="server" Text="" MaxLength="20" Visible="True" Width="200px" Height="16px"></asp:TextBox></td>

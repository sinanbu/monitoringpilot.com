<%@ Page Language="C#" AutoEventWireup="true" CodeFile="survey3.aspx.cs" Inherits="survey3" EnableEventValidation="false" %>
...
<tr><td style="text-align:left; width:100% ;" colspan="2"><span style="font-family:'Trebuchet MS'; color:#222; font-size:medium; margin:0; ">
    <b>VARDİYA DÜZENİ (8-16) AR-GE ANKETİ </b><br /><br /></span></td>
</tr>
    <tr>
    <td style="text-align:left; width:7% ;"><img src="images/Survey100.jpg" /></td> 
        <td style="text-align:left; vertical-align:top; width:93% ;"><span style="font-family:'Trebuchet MS'; vertical-align:top; color:#222; margin:0; ">
            Küresel bir salgın haline gelen Corona virüse karşı mücadele konusunda Ülkemizde alınan tedbirler,
Sağlık kurulunun tavsiyeleri ve 14 günlük karantina süresi uygulamaları düşünülerek;
Yurtdışı irtibatlı olan gemilerle sürekli temas halinde olan özellikle kılavuz kaptanların korunması ve eğer virüse yakalanma durumunda gerekli olan tedavi ve karantina süresini
sağlayabilmek adına Şirketimiz, pilotlarımızın kabul etmesi durumunda vardiya çalışma süresini gecici olarak 8 gün içeri 16 gün dışarı
şeklinde uygulanabileceğini belirtmiştir. 
Bu sebeple Şirketimiz vardiyanın 8-16 gün olması konusunda pilotların görüşünü alacaktır. Seçiminizi yapmak için
        aşağıdaki 'Ankete Katıl' butonuna tıklayınız.</br></br>
                      <ul>
  <li class="sagusttuslist"><asp:LinkButton ID="LBaddvote" OnClick="LBaddvote_Click" class="sagusttuslista" runat="server"  Text=" Ankete Katıl "></asp:LinkButton></li>
</ul>
</br></br></td></tr>
...
<table >                        
            ...
            <tr>
                ...
                <td  class="tdsag" ><div><b>Açıklama:</b> 
                    Aşağıdaki açılır listeden uygun seçeneği seçerek OYLA tuşuna basınız. İsterseniz daha sonra seçiminizi tekrar düzenleyebilirsiniz.<br /> <br /> </td>
            </tr>
                <tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="statisticsd.aspx.cs" Inherits="yonet_statisticsd" %>
...
<%--            <li class="liistatik1">  <asp:LinkButton ID="liistatik2" runat="server"  OnClick="liistatik2_Click">2M Summary</asp:LinkButton></li>
            ...
            <li class="liistatik1a">  <asp:Label ID="liistatik4" runat="server" >Per Pilot</asp:Label></li>
        ...
        <div class="clearup">
          ...
          <br />
            ...
            <asp:Button ID="LBgetist3" runat="server" OnClick="LBgetist3_Click" Text="Get Data" Width="90px" Height="24px"></asp:Button>
                    ...
                    <asp:Label ID="baslik4" runat="server"> <div  class="yazibigbold"><p></p>
                             <asp:Label ID="Lwoidpp" runat="server" ></asp:Label> </div></asp:Label> 
                        
                         <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CellPadding="2" DataKeyNames="id" ForeColor="#333333" GridLines="Vertical" OnSelectedIndexChanging="GridView4_SelectedIndexChanging" Width="911px" AllowPaging="True" PageSize="50" OnPageIndexChanging="GridView4_PageIndexChanging">
                             ...
                             <Columns>
                                 ...
                                 <asp:TemplateField ControlStyle-Width="100px" HeaderText="Ship Name">
                                     <ItemTemplate>
                                 ...
                                 <asp:TemplateField ControlStyle-Width="140px" HeaderText="Departure">
                                  ...
                                  <asp:TemplateField ControlStyle-Width="118px" HeaderText="Off Station ">
                                     <ItemTemplate>
                                         <asp:Label ID="sofpp" runat="server" ><%#Eval("istasyoncikis") %> </asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

                                  <asp:TemplateField ControlStyle-Width="117px" HeaderText="On Station">
                                     <ItemTemplate>
                                         <asp:Label ID="sonpp" runat="server" ><%#Eval("istasyongelis")%>  </asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

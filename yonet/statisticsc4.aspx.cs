...
public partial class yonet_statisticsc4 : System.Web.UI.Page
{
    ...
    {
        SqlConnection baglanti = AnaKlas.baglan();
        SqlCommand cmdtoppil = new SqlCommand("select  top 3  count(kapno) as say,kapno from vardiyadetay where (istasyongelis like '%2024%' and grt!='' and manevraiptal='0') group by kapno order by count(kapno) desc", baglanti);
    ...
    {
        SqlConnection baglanti = AnaKlas.baglan();
        SqlCommand cmdtopw = new SqlCommand("select  TOP 3  count(varno) as say,varno from vardiyadetay where (istasyongelis like '%2024%' and grt!='' and manevraiptal='0') group by varno order by count(varno) desc ", baglanti);
    ...
    private void ikiaylikvarbir()
    {
        ...
        SqlCommand totaljobs = new SqlCommand("Select count(istasyongelis) from vardiyadetay where istasyongelis like '%2024%' and manevraiptal ='0' and varid='1'  and grt!=''  ", baglanti);
        ...
        if (count != 0)
        {
            ...
            { 
                ...
                var veri2 = entuc.vardiyadetay
                    .ToList()
                    .Where(c => c.manevraiptal == "0" && c.varid == "1" && c.istasyongelis.Contains("2024") && c.grt != "");
                ...
                using (PilotdbEntitiesPilotlar entpilotlar = new PilotdbEntitiesPilotlar())
                {
                    ...
                    {
                        SqlCommand totaljobsgun = new SqlCommand("Select count(DISTINCT(Substring(istasyongelis,0,6))) from vardiyadetay where istasyongelis like '%2024%' and manevraiptal ='0' and kapno='" + a.kapno + "'  and grt!='' ", baglanti);
    ...
    private void ikiaylikvariki()
    {
        ...
        //iş saysısı toplami al 
        SqlCommand totaljobs = new SqlCommand("Select count(istasyongelis) from vardiyadetay where istasyongelis like '%2024%' and manevraiptal ='0' and varid='2'  and grt!='' ", baglanti);
        ...
        if (count != 0)
        {
            using (PilotdbEntitiesvardetay entuc = new PilotdbEntitiesvardetay())
            {
                ...
                var veri2 = entuc.vardiyadetay
                    .ToList()
                    .Where(c => c.manevraiptal == "0" && c.varid == "2" && c.istasyongelis.Contains("2024") && c.grt != "");
    ...
    private void ikiaylikvaruc()
    {
        ...
        //iş saysısı toplami al 
        SqlCommand totaljobs = new SqlCommand("Select count(istasyongelis) from vardiyadetay where istasyongelis like '%2024%' and manevraiptal ='0' and varid='3'  and grt!='' ", baglanti);
        ...
        if (count != 0)
        {
            using (PilotdbEntitiesvardetay entuc = new PilotdbEntitiesvardetay())
            {
                ...
                var veri2 = entuc.vardiyadetay
                    .ToList()
                    .Where(c => c.manevraiptal == "0" && c.varid == "3" && c.istasyongelis.Contains("2024") && c.grt!="");

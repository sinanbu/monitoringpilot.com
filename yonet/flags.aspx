<%@ Page Language="C#" AutoEventWireup="true" CodeFile="flags.aspx.cs" Inherits="yonet_flags"  MaintainScrollPositionOnPostback="true"%>
  ...
  <div id="middle">
    ...
    <div id="left-column"> 
      ...
      <h3>Flags</h3> <ul class="nav">        
        <li id="ulnavlihover"><a>Flags</a></li></ul>
    ...
    <div id="center-column">
      <div class="top-bar"> 
          ...
          <ul>
  <li class="sagusttuslist"><asp:LinkButton ID="LBaddnewportberth" class="sagusttuslista" runat="server" OnClick="LBaddnewportberth_Click">Add New Flag</asp:LinkButton></li>
</ul>

        <h1><a href="yonetim.aspx">Settings</a> > Flags </h1>
      ...
      <div class="table">
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="747px"   OnRowCancelingEdit="GridView1_RowCancelingEdit" DataKeyNames="id" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating"  OnSelectedIndexChanging="GridView1_SelectedIndexChanging" CellPadding="2" ForeColor="#333333"  GridLines="Vertical"  AllowPaging="True" PageSize="50" OnPageIndexChanging="GridView1_PageIndexChanging">
...
<asp:TemplateField HeaderText="Country"  ControlStyle-Width="200px" >
                    <EditItemTemplate> <asp:TextBox ID="TBeditportlimanadi" runat="server" CssClass="kucukharf"  MaxLength="20" Text='<%# Bind("flag") %>'></asp:TextBox></EditItemTemplate>
                    <ItemTemplate><asp:Label ID="Litemportlimanadi" runat="server" Text='<%# Bind("flag") %>'></asp:Label></ItemTemplate>
...
<table  class="panellbadd">                        
            ...
            <tr>
                <td >ID : </td>
                <td  class="tdsag" ><div>
                    <asp:TextBox ID="TBpaddportno" Width="30px" runat="server" MaxLength="3" Enabled="false"></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" TargetControlID="TBpaddportno" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender></div>
                </td>
            </tr>
            <tr>
                <td >Country: </td>
                <td  class="tdsag" >
                    <asp:TextBox ID="TBpaddportname" Width="150px" runat="server"   CssClass="kucukharf" ></asp:TextBox>
                </td>
            </tr>
                        <tr>
                <td >Show : </td>

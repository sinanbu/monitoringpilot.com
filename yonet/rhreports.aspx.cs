...
public partial class rhreports : System.Web.UI.Page
{
            ...
            if (kaprdr.HasRows)
            {
                while (kaprdr.Read())
                {
                    ...
                    while (i < 49)
                    {
                        ...
                        if ((istcikdec < i / 2 && istgeldec + 0.5 >= i / 2))
                        {
                    ...
                    topcalsurpart = istgeldec - istcikdec;
    ...
    {
        Response.Redirect("rhreportspob.aspx");
    }
}

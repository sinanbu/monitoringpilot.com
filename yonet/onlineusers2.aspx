<%@ Page Language="C#" AutoEventWireup="true" CodeFile="onlineusers.aspx.cs" Inherits="yonet_onlineusers" EnableEventValidation="true" %>
...
<div id="header-right">MPTR Admin Page</div>
  ...
  <div id="middle">
    ...
    <div id="center-column">
      <div class="top-bar"> 
        <h1><a href="offlineusers.aspx">Online Users</a></h1>    
...
<ItemTemplate><asp:Label ID="Litemportlimanno" runat="server" Text='<%#  Eval("kapno")  %>'></asp:Label></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="KapsiraNo" ControlStyle-Width="40px" >
<ItemTemplate><asp:Label ID="Litekapsirano" runat="server" Text='<%#  Eval("kapsirano")  %>'></asp:Label></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Times" ControlStyle-Width="40px" >
<ItemTemplate><asp:Label ID="Litetimes" runat="server" Text='<%#  Eval("times")  %>'></asp:Label></ItemTemplate></asp:TemplateField>




<asp:TemplateField HeaderText="Name Surname"  ControlStyle-Width="230px" >
<ItemTemplate><asp:LinkButton  OnClick="kapadi_Click" Font-Underline="false"   CommandArgument='<%#Eval("kapno")%>' ID="Litemportlimanadi"  runat="server" Text='<%# Bind("kapadisoyadi") %>'></asp:LinkButton></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="PC-IP"  ControlStyle-Width="160px" >
<ItemTemplate><asp:Label ID="LBstarti" runat="server" Text='<%# Bind("pcip") %>'></asp:Label></ItemTemplate></asp:TemplateField>

                
<asp:TemplateField HeaderText="Login Time"  ControlStyle-Width="160px" >
<ItemTemplate><asp:Label ID="LBfinishi" runat="server" Text='<%# Bind("login") %>'></asp:Label></ItemTemplate></asp:TemplateField>
        ...
        <asp:Panel ID="paneleditpilot"  runat="server" CssClass="panellbadd1" ScrollBars="Vertical"> 
...
<div style="border:1px solid white; background-color:orange; font-size:16px; font-weight:bold; height:30px ; text-align:left" >
    <strong> <asp:Button ID="ButtonPilotEDTcancel" runat="server" style="height:30px; Width:30px" Text="X"  CssClass="btn"/>
        <asp:label  ID="Lblpilotname" runat="server" Text="" ></asp:label> online times.</strong></div>
          ...
          <table style="width:100%">
                    <tr style="border-bottom: 1px solid gray; border-left:1px solid aliceblue; height:22px; text-align:left; font-weight:bold;">
                        ...
                        <td  style="width:37% "><asp:Label ID="Lkapadi" runat="server" Text='Pilot Name'></asp:Label></td>
                        ...
                        <td  style="width:20% "><asp:label  ID="Llogof" runat="server" Text='Logof Time' ></asp:label></td>
                    </tr>    </table>
...
<asp:ListView ID="ListView1" runat="server"  >
                ...
                <itemtemplate >
                    ...
                    <tr style="border-bottom: 1px solid gray; border-left:1px solid aliceblue; height:22px; text-align:left">
                        ...
                        <td  style="width:37% "><asp:Label ID="Lkapadi" runat="server" Text='<%#Eval("kapadisoyadi") %>'></asp:Label></td>
                        ...
                        <td  style="width:20% "><asp:label  ID="Llogof" runat="server" Text='<%#Eval("logof")%>' ></asp:label></td>
                    </tr>    </table> </div>
              </itemtemplate>

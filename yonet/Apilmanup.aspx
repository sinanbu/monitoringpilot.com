<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apilmanup.aspx.cs" Inherits="Apilmanup" EnableEventValidation="false" %>
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCancelingEdit="GridView1_RowCancelingEdit" DataKeyNames="kapno" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" CellPadding="2" ForeColor="#333333" GridLines="Vertical">
           ...
           <Columns>
               ...
               <asp:TemplateField HeaderText="Gemi Adı" ControlStyle-Width="100px">
                   <ItemTemplate>
                       <asp:Label ID="Lgemiadi" runat="server" Text='<%# Bind("gemiadi") %>'></asp:Label>
                   </ItemTemplate>
               </asp:TemplateField>

               <asp:TemplateField HeaderText="İstasyon Çıkış" ControlStyle-Width="130px">
                   <EditItemTemplate><asp:TextBox ID="TBistasyoncikis" runat="server" Text='<%# Bind("istasyoncikis") %>'  ></asp:TextBox></EditItemTemplate>
                   <ItemTemplate>    <asp:Label ID="Listasyoncikis" runat="server" Text='<%# Bind("istasyoncikis") %>'></asp:Label></ItemTemplate>
               </asp:TemplateField>

               <asp:TemplateField HeaderText="PoB" ControlStyle-Width="130px">
                   <EditItemTemplate><asp:TextBox ID="TBpob" runat="server" Text='<%# Bind("pob") %>'  ></asp:TextBox></EditItemTemplate>
               ...
               <asp:TemplateField HeaderText="PoFF" ControlStyle-Width="130px">
                   <EditItemTemplate><asp:TextBox ID="TBpoff" runat="server" Text='<%# Bind("poff") %>'   ></asp:TextBox></EditItemTemplate>

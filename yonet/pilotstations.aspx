<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pilotstations.aspx.cs" Inherits="yonet_pilotstations"  MaintainScrollPositionOnPostback="true"%>
  ...
  <div id="middle">
    ...
    <div id="left-column"> 
      ...
      <h3>Pilot Stations</h3><ul class="nav">
        <li  id="ulnavlihover"><a>Pilot Stations</a></li></ul>
    ...
    <div id="center-column">
      <div class="top-bar">
          ...
          <ul>
  <li class="sagusttuslist">  <asp:LinkButton ID="LBaddnewportberth" class="sagusttuslista" runat="server" OnClick="LBaddnewportberth_Click" >Add New Pilot Station</asp:LinkButton></li>
</ul>

        <h1><a href="yonetim.aspx">Settings</a> > Pilot Stations </h1>
...
<asp:CommandField ButtonType="Image" SelectImageUrl="~/images/arrowr.png"  HeaderText=""  SelectText="" ItemStyle-Width="40px"   ShowSelectButton="True" />

<asp:TemplateField HeaderText="P.No"  ControlStyle-Width="60px" >
...
<asp:TemplateField HeaderText="Port Name"  ControlStyle-Width="217px" >
                    <EditItemTemplate><asp:TextBox ID="TBeditportlimanadi" runat="server" Enabled="false"  CssClass="kucukharf" MaxLength="20" Text='<%# Bind("limanadi") %>' ></asp:TextBox></EditItemTemplate>
...
<asp:TemplateField HeaderText="Area"   ControlStyle-Width="60px">
                    <EditItemTemplate><asp:TextBox ID="TBeditportlimanbolge" Enabled="false" runat="server" Text='<%# Bind("limanbolge") %>' MaxLength="2" ></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender9" TargetControlID="TBeditportlimanbolge" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender> </EditItemTemplate>
...
<asp:TemplateField HeaderText="Stn."   ControlStyle-Width="60px">
                    <EditItemTemplate><asp:TextBox ID="TBeditportresp" runat="server" Enabled="false"  Text='<%# Bind("bagliistasyon") %>' MaxLength="1" ></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender11" TargetControlID="TBeditportresp" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender></EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="B.T." ControlStyle-Width="60px">
                ...
                <asp:TemplateField HeaderText="UB.T." ControlStyle-Width="60px">
                ...
                <asp:TemplateField HeaderText="Show"   ControlStyle-Width="60px">
...
<asp:CommandField  ItemStyle-Width="80px" ShowEditButton="True"  EditImageUrl="../images/edit.png"  EditText=""   UpdateText="" UpdateImageUrl="../images/save.png"  CancelImageUrl="../images/cancel.png"   CancelText=""  ButtonType="Image" >
                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                </asp:CommandField>

<asp:CommandField ItemStyle-Width="50px" ShowDeleteButton="True"  DeleteImageUrl="../images/cancelsil.png" DeleteText=""    ButtonType="Image">
                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                </asp:CommandField>
...
<table  class="panellbadd">                        
                ...
                <td colspan="2"  class="tdorta"  >
                 <p style="box-shadow: inset; text-align: center; width: 100% auto; height: 30px; font-weight: bold; font-family: 'Trebuchet MS'">Add New Pilot Station </p></td>
            </tr>          
            <tr>
                <td >Station No : </td>
                <td  class="tdsag"><div>
                    <asp:TextBox ID="TBpaddportno" Width="40px" runat="server" MaxLength="4"  Enabled="false"></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" TargetControlID="TBpaddportno" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
            ...
            <tr>
                <td >Port Area : </td>
                <td  class="tdsag">
                    <asp:TextBox ID="TBpaddportarea"  runat="server" Width="150px"  Enabled="false" MaxLength="2"></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" TargetControlID="TBpaddportarea" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                </td>
            </tr>
                ...
                <td >Resp.Station : </td>
                <td  class="tdsag">
                    <asp:TextBox ID="TBpaddresp"  runat="server" Width="50px"  Enabled="false" MaxLength="1"></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" TargetControlID="TBpaddresp" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                </td>
            </tr>
                    <tr>
                <td >Boarding Time : </td>

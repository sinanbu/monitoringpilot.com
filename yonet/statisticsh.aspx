<%@ Page Language="C#" AutoEventWireup="true" CodeFile="statisticsh.aspx.cs" Inherits="yonet_statisticsh" %>
...
<%--            <li class="liistatik1">  <asp:LinkButton ID="liistatik2" runat="server"  OnClick="liistatik2_Click">2M Summary</asp:LinkButton></li>
            ...
            <li class="liistatik1a">  <asp:Label ID="liistatik8" runat="server"  >One Month</asp:Label></li>
        ...
        <div class="clearup">
          ...
          <br />
            ...
            <%--arama radio no.8 One Month--%>
    <asp:TextBox ID="TextBox8" runat="server" MaxLength="7"   Font-Size="Small" Width="90px" Height="22px"  ></asp:TextBox>
<asp:MaskedEditExtender  CultureName="tr-TR"  ID="MaskedEditExtender8" runat="server" TargetControlID="TextBox8" ErrorTooltipEnabled="true" MaskType="Number" Mask="99/9999"></asp:MaskedEditExtender>
               
                     <asp:Button ID="LBgetist3" runat="server" OnClick="LBgetist3_Click" Text="Get Data" Width="90px" Height="24px"></asp:Button>
 
                    <asp:Label ID="baslik8" runat="server"> <div  class="yazibigbold"><p></p>
                             <asp:Label ID="Lwoidaylik" runat="server" ></asp:Label>   </div></asp:Label>
                       
                         <asp:GridView ID="GridView8" runat="server" AutoGenerateColumns="False" CellPadding="2" DataKeyNames="id" ForeColor="#333333" GridLines="Vertical" OnSelectedIndexChanging="GridView8_SelectedIndexChanging"  Width="911px" AllowPaging="True" PageSize="50" OnPageIndexChanging="GridView8_PageIndexChanging">
                             ...
                             <Columns>
                                 <asp:CommandField ButtonType="Image" HeaderText="" ItemStyle-Width="24px" SelectImageUrl="~/images/arrowr.png" SelectText="" ShowSelectButton="True" />
                                  ...
                                  <asp:TemplateField ControlStyle-Width="130px" HeaderText="Pilot Name">
                                     <ItemTemplate>
                                         <asp:Label ID="pilotmo" runat="server" Text='<%# Bind("pilotismi") %>'></asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

                                 <asp:TemplateField ControlStyle-Width="125px" HeaderText="Ship Name">
                                     <ItemTemplate>
                                         <asp:Label ID="shipmo" runat="server"  Text='<%# Bind("gemiadi") %>'></asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

                                 <asp:TemplateField ControlStyle-Width="60px" HeaderText="Type/Grt">
                                     <ItemTemplate>
                                         <asp:Label ID="tgrtmo" runat="server" ><%#Eval("tipi")%>/<%#Eval("grt")%></asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

                                 <asp:TemplateField ControlStyle-Width="125px" HeaderText="Departure">
                                     <ItemTemplate>
                                         <asp:Label ID="depmo" runat="server" ><%#Eval("binisyeri") %> <%#Eval("binisrihtim") as string == "0" || Eval("binisrihtim") as string == ""  ? "" : "/" + Eval("binisrihtim")   %></asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

                                  <asp:TemplateField ControlStyle-Width="125px" HeaderText="Destination">
                                     <ItemTemplate>
                                         <asp:Label ID="destmo" runat="server" ><%#Eval("inisyeri") %> <%#Eval("inisrihtim")  as string == "0" || Eval("inisrihtim") as string == ""  ? "" : "/" +  Eval("inisrihtim")  %></asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

                                  <asp:TemplateField ControlStyle-Width="118px" HeaderText="Off Station ">
                                     <ItemTemplate>
                                         <asp:Label ID="sofmo" runat="server" ><%#Eval("istasyoncikis") %> </asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

                                  <asp:TemplateField ControlStyle-Width="117px" HeaderText="On Station">
                                     <ItemTemplate>
                                         <asp:Label ID="sonmo" runat="server" ><%#Eval("istasyongelis")%>  </asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

                                   <asp:TemplateField ControlStyle-Width="20px" HeaderText="X" >
                                     <ItemTemplate>
                                         <asp:Label ToolTip='<%#Eval("manevraiptal") as string == "1"  ? "" : "Cancelled" %>' ID="cancelmo" runat="server" ><%#Eval("manevraiptal") %></asp:Label>
                                     </ItemTemplate>
                                 </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tugs.aspx.cs" Inherits="yonet_tugs"  MaintainScrollPositionOnPostback="true"%>
...
<div id="header-right"><asp:Literal ID="Litpagebaslik" runat="server" ></asp:Literal></div>
  ...
  <li class="sagusttuslist"><asp:LinkButton ID="LBaddnewportberth" class="sagusttuslista" runat="server" OnClick="LBaddnewportberth_Click">Add New Ship Type</asp:LinkButton></li>
        ...
        <h1><a href="yonetim.aspx">Settings</a> >Tugs </h1>
...
<asp:TemplateField HeaderText="Tug Name"  ControlStyle-Width="200px" >
                    <EditItemTemplate> <asp:TextBox ID="TBeditportlimanadi" runat="server" CssClass="kucukharf"  MaxLength="30" Text='<%# Bind("boatname") %>'></asp:TextBox></EditItemTemplate>
                    <ItemTemplate><asp:Label ID="Litemportlimanadi" runat="server" Text='<%# Bind("boatname") %>'></asp:Label></ItemTemplate>
                     <ControlStyle></ControlStyle>
                    <FooterStyle Font-Names="Trebuchet MS" Font-Size="Small" />
...
<asp:TemplateField HeaderText="Short"  ControlStyle-Width="60px" >
                    <EditItemTemplate><asp:TextBox ID="TBeditportshort" runat="server" Text='<%# Bind("short") %>' MaxLength="4" ></asp:TextBox></EditItemTemplate>
                    <ItemTemplate><asp:Label ID="Litemportshort" runat="server" Text='<%# Bind("short") %>'></asp:Label></ItemTemplate>
                    <ControlStyle  ></ControlStyle>
                    <FooterStyle Font-Names="Trebuchet MS" Font-Size="Small" />
                    <HeaderStyle Font-Names="Trebuchet MS" Font-Size="Small" HorizontalAlign="Left" VerticalAlign="Middle" />
                    <ItemStyle Font-Names="Trebuchet MS" Font-Size="Small" />
...
<asp:TemplateField HeaderText="Type"  ControlStyle-Width="60px" >
                    <EditItemTemplate><asp:TextBox ID="TBeditporttype" runat="server" Text='<%# Bind("type") %>' MaxLength="1" ></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender15" TargetControlID="TBeditporttype" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender></EditItemTemplate>
                    <ItemTemplate><asp:Label ID="Litemporttype" runat="server" Text='<%# Bind("type") %>'></asp:Label></ItemTemplate>
                    <ControlStyle  ></ControlStyle>
                    <FooterStyle Font-Names="Trebuchet MS" Font-Size="Small" />
                    <HeaderStyle Font-Names="Trebuchet MS" Font-Size="Small" HorizontalAlign="Left" VerticalAlign="Middle" />
                    <ItemStyle Font-Names="Trebuchet MS" Font-Size="Small" />
...
<asp:TemplateField HeaderText="Tons"  ControlStyle-Width="60px" >
                    <EditItemTemplate><asp:TextBox ID="TBeditporttons" runat="server" Text='<%# Bind("tons") %>' MaxLength="3" ></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender14" TargetControlID="TBeditporttons" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender></EditItemTemplate>
                    <ItemTemplate><asp:Label ID="Litemporttons" runat="server" Text='<%# Bind("tons") %>'></asp:Label></ItemTemplate>
                    <ControlStyle  ></ControlStyle>
                    <FooterStyle Font-Names="Trebuchet MS" Font-Size="Small" />
                    <HeaderStyle Font-Names="Trebuchet MS" Font-Size="Small" HorizontalAlign="Left" VerticalAlign="Middle" />
                    <ItemStyle Font-Names="Trebuchet MS" Font-Size="Small" />
                ...
                <asp:TemplateField HeaderText="Bölge"  ControlStyle-Width="60px" >
                    <EditItemTemplate><asp:TextBox ID="TBeditportbolge" runat="server" Text='<%# Bind("bolge") %>' MaxLength="1" ></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender14a" TargetControlID="TBeditportbolge" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender></EditItemTemplate>
                    <ItemTemplate><asp:Label ID="Litemportbolge" runat="server" Text='<%# Bind("bolge") %>'></asp:Label></ItemTemplate>
                    <ControlStyle  ></ControlStyle>
                    <FooterStyle Font-Names="Trebuchet MS" Font-Size="Small" />
                    <HeaderStyle Font-Names="Trebuchet MS" Font-Size="Small" HorizontalAlign="Left" VerticalAlign="Middle" />
                    <ItemStyle Font-Names="Trebuchet MS" Font-Size="Small" />
...
<table  class="panellbadd">                        
            ...
            <tr>
                <td >ID : </td>
                <td  class="tdsag" >
                    <asp:TextBox ID="TBpaddportno" Width="30px" runat="server" MaxLength="2" Enabled="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td >Tug Name : </td>
                <td  class="tdsag" >
                    <asp:TextBox ID="TBpaddportname" Width="150px" runat="server"  MaxLength="30"  CssClass="kucukharf" ></asp:TextBox>
                </td>
            </tr>
                <tr>
                <td >Short Name : </td>
                <td  class="tdsag" >
                    <asp:TextBox ID="TBpaddportshort" Width="150px" runat="server"  MaxLength="4"  CssClass="kucukharf" ></asp:TextBox>
                </td>
            </tr>
                    <tr>
                <td >Type : </td>
                <td  class="tdsag" >
                    <asp:TextBox ID="TBpaddporttype" Width="150px" runat="server"  MaxLength="1"  CssClass="kucukharf" ></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" TargetControlID="TBpaddporttype" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                </td>
            </tr>
                        <tr>
                <td >Tons : </td>
                <td  class="tdsag" >
                    <asp:TextBox ID="TBpaddporttons" Width="30px" runat="server" MaxLength="3"></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" TargetControlID="TBpaddporttons" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                </td>
            </tr>
                ...
                <td >Bölge : </td>
                <td  class="tdsag" >
                    <asp:TextBox ID="TBpaddportbolge" Width="30px" runat="server" MaxLength="1"></asp:TextBox><asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2a" TargetControlID="TBpaddportbolge" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                </td>
            </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="survey4.aspx.cs" Inherits="survey4" EnableEventValidation="false" %>
...
<tr><td style="text-align:left; width:100% ;" colspan="2"><span style="font-family:'Trebuchet MS'; color:#222; font-size:medium; margin:0; ">
    <b>VARDİYA DEĞİŞİM SAATİ AR-GE ANKETİ </b><br /><br /></span></td>
</tr>
    <tr>
    <td style="text-align:left; width:7% ;"><img src="images/Survey100.jpg" /></td> 
        <td style="text-align:left; vertical-align:top; width:93% ;"><span style="font-family:'Trebuchet MS'; vertical-align:top; color:#222; margin:0; ">
            Pilotların vardiya günü istasyonlara geliş yollarındaki zaman kayıplarının 
            önlenmesi amacıyla Şirketimiz vardiya değişim saati konusunda bir kez daha pilotların görüşünü alarak son kararı verecektir.
            Seçiminizi yapmak için aşağıdaki 'Ankete Katıl' butonuna tıklayınız.</br></br>
                      <ul>
...
<tr><td style="text-align:left; font-size:16px; width:100% ; height:25px" colspan="2">
    <b>Sonuçlar</b></br>
    <b>Katılan : </b><asp:Label ID="sonuc1" runat="server"></asp:Label></br>
    <b>Bekleyen : </b><asp:Label ID="sonuc2" runat="server"></asp:Label></br>
    <b><asp:Label  style="color:darkred;"  ID="sonuc3" runat="server"></asp:Label> : </b><asp:Label  style="color:red;" ID="sonuc6" runat="server"></asp:Label></br>
    <b><asp:Label  style="color:darkgreen;" ID="sonuc4" runat="server"></asp:Label> : </b><asp:Label  style="color:green;" ID="sonuc7" runat="server"></asp:Label></br>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YarimcaShips.aspx.cs" Inherits="YarimcaShips" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
    <title>MonitoringPilot - Yarımca Ships</title>
        ...
        <div style="width: 100%; text-align: left;">
            <asp:Panel ID="panel2" runat="server">
                ...
                <button runat="server"  id="Bdaricaships" style=" border:1px solid black;  cursor:pointer; background-color:#7DA3CD; height: 25px; Width: 90px; font-size: 11px; text-align: center;"  onclick="window.location.href='daricaships.aspx'" >Darıca Ships</button>&nbsp;
                        ...
                        <asp:Label  runat="server" CssClass="tablobaslik3" Text="CONTACTED VESSELS"></asp:Label>
                                ...
                                <ItemTemplate>
                                    <tr id="Row" runat="server" class="trsatir2 rowflash"  style="background-color:#ffffd0">
                                        ...
                                        <td class="tdis2 "  id="warngemitd">
                                            ...
                                            <asp:Label ID="LBLgemiadi1c" runat="server" Visible="false" Font-Bold="true" Text='<%#Eval("gemiadi")%>'></asp:Label>
                        ...
                        <asp:Label  runat="server"  CssClass="tablobaslik3"  Text="HEREKE PORTS"></asp:Label>
                        <asp:Panel ID="panelcollapseher" Style="display: block; overflow: hidden;" runat="server">
                            <asp:Repeater ID="DLher" runat="server" OnItemDataBound="DLher_ItemDataBound">
                                ...
                                <ItemTemplate>
                                    <tr  id="Row"  runat="server" class="trsatir3 rowflash">
                                        <td class ="tdis1 ">
                                        ...
                                        <td class="tdis2 "  id="warngemitd">
                                            <asp:Button ID="LBpata" BorderWidth="0"  OnClick="LBpata_Click" runat="server"  CssClass="butongemi3"  Text='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' ></asp:Button><asp:Label ID="LBLgemiadi8" runat="server" Visible="false" Font-Bold="true" Text='<%#Eval("gemiadi")%>'></asp:Label></td>
                                        <td class="tdis16" id="warntd">
                                            <asp:Label ID="notlar" runat="server" Text='<%#Eval("notlar").ToString().Length>33? (Eval("notlar") as string).Substring(0,34)+"." : Eval("notlar")%>' ToolTip='<%#Eval("notlar") %>'></asp:Label><asp:Label ID="notlar2" runat="server" Text='<%#Eval("notlar")%>' Visible="false"></asp:Label></td>
                        ...
                        <asp:Label  runat="server"  CssClass="tablobaslik3"  Text="HEREKE-İZMİT-YARIMCA ANCHORAGE"></asp:Label>
                        <asp:Panel ID="panelcollapseyaranc" Style="display: block; overflow: hidden;" runat="server">
                            <asp:Repeater ID="DLyaranc" runat="server" OnItemDataBound="DLyaranc_ItemDataBound">
                                ...
                                <ItemTemplate>
                                   <tr  id="Row"  runat="server" class="trsatir3 rowflash">
                                            <td class ="tdis1 ">
                                                <asp:Label ID="LBshipgec6" runat="server" ForeColor="Red" Font-Bold="true" Text='<%# Container.ItemIndex +1 %>'></asp:Label><asp:LinkButton ID="LBpatashiphis6" runat="server" Style="cursor: pointer; text-decoration: none;" Font-Bold="true" Visible="false"> <%#Eval("id")%> </asp:LinkButton></td>
                                          <td class="tdis2 "  id="warngemitd">
                                                <asp:Button ID="LBpata"  BorderWidth="0"  OnClick="LBpata_Click" runat="server"  CssClass="butongemi3"  Text='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' ></asp:Button><asp:Label ID="LBLgemiadi6" runat="server" Visible="false" Font-Bold="true" Text='<%#Eval("gemiadi")%>'></asp:Label></td>
                                        <td class="tdis16" id="warntd">
                                            <asp:Label ID="notlar" runat="server" Text='<%#Eval("notlar").ToString().Length>33? (Eval("notlar") as string).Substring(0,34)+"." : Eval("notlar")%>' ToolTip='<%#Eval("notlar") %>'></asp:Label><asp:Label ID="notlar2" runat="server" Text='<%#Eval("notlar")%>' Visible="false"></asp:Label></td>
                                        ...
                                        <td class="tdis15">
                                            ...
                                            <td class ="tdis18 ">
                                                <asp:ImageButton ID="ImageButtonJobEdit6" CommandName='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' runat="server" ImageUrl="~/images/edit.png" Width="16px" OnClick="ImageButtonJobEdit_Click" />
                                            <asp:Label Font-Size="8px" ID="Lblkaydeden" runat="server" Text='<%#Eval("kaydeden")%>'></asp:Label>                                              
                                            </td>
                        ...
                        <asp:Label  runat="server"  CssClass="tablobaslik3" Text="YARIMCA PORTS"></asp:Label>
                        <asp:Panel ID="panelcollapseyarport" Style="display: block; overflow: hidden;" runat="server">
                            <asp:Repeater ID="DLyarport" runat="server"  OnItemDataBound="DLyarport_ItemDataBound">
                                ...
                                <ItemTemplate>
                                        <tr  id="Row"  runat="server" class="trsatir3 rowflash">
                                            <td class ="tdis1 ">
                                                <asp:Label ID="LBshipgec7" runat="server" ForeColor="Red" Font-Bold="true" Text='<%# Container.ItemIndex +1 %>'></asp:Label><asp:LinkButton ID="LBpatashiphis7" runat="server" Style="cursor: pointer; text-decoration: none;" Font-Bold="true" Visible="false"> <%#Eval("id")%> </asp:LinkButton></td>
                                       <td class="tdis2 "  id="warngemitd">
                                                <asp:Button ID="LBpata"  BorderWidth="0"  OnClick="LBpata_Click" runat="server"  CssClass="butongemi3" Text='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' ></asp:Button><asp:Label ID="LBLgemiadi7" runat="server" Visible="false" Font-Bold="true" Text='<%#Eval("gemiadi")%>'></asp:Label></td>
                                        <td class="tdis16" id="warntd">
                                            <asp:Label ID="notlar" runat="server" Text='<%#Eval("notlar").ToString().Length>33? (Eval("notlar") as string).Substring(0,34)+"." : Eval("notlar")%>' ToolTip='<%#Eval("notlar") %>'></asp:Label><asp:Label ID="notlar2" runat="server" Text='<%#Eval("notlar")%>' Visible="false"></asp:Label></td>
                                        ...
                                        <td class="tdis15">
                                            ...
                                            <td  id="tdlcb" class ="tdis17 ">
                                                <asp:Button ID="Lbl20" runat="server" CssClass="butongemi2"  CommandName='<%#Eval("gemiadi")%>' Font-Underline="false"  OnClick="Lbl20_Click"  CommandArgument='<%#Eval("id")%>' Text='<%#Eval("talepno").ToString().Length>6? (Eval("talepno") as string).Substring(0,7)+"." : Eval("talepno")%>'  ToolTip='<%# "Req :" + Eval("talepno") + " / Prq :" + Eval("pratikano") + " / LÇB :" + Eval("lcbno") + " , " + Eval("lcbdest")+ " , " + Eval("lcbdate") %>'></asp:Button><asp:Label ID="Labellcbdate" Visible="false" runat="server" Text='<%#Eval("lcbdate")%>'></asp:Label></td>
                                            <td class ="tdis18 ">
                                                <asp:ImageButton ID="ImageButtonJobEdit7" CommandName='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' runat="server" ImageUrl="~/images/edit.png" Width="16px" OnClick="ImageButtonJobEdit_Click" />
                                             <asp:Label Font-Size="8px" ID="Lblkaydeden" runat="server" Text='<%#Eval("kaydeden")%>'></asp:Label>
                                            </td>
                        ...
                        <asp:Label  runat="server"  CssClass="tablobaslik3"  Text="KOSBAŞ SHIPYARD"></asp:Label>
                        <asp:Panel ID="panelcollapsekosbas" Style="display: block; overflow: hidden;" runat="server">
                            <asp:Repeater ID="DLVIPortKosb" runat="server"  OnItemDataBound="DLVIPortKosb_ItemDataBound">
                                ...
                                <ItemTemplate>
                                    <tr  id="Row"  runat="server" class="trsatir3 rowflash">
                                            <td class ="tdis1">
                                                <asp:Label ID="LBshipgec5" runat="server" ForeColor="Red" Font-Bold="true" Text='<%# Container.ItemIndex +1 %>'></asp:Label><asp:LinkButton ID="LBpatashiphis5" runat="server" Style="cursor: pointer; text-decoration: none;" Font-Bold="true" Visible="false"> <%#Eval("id")%> </asp:LinkButton></td>
                                         <td class="tdis2 "  id="warngemitd">
                                                <asp:Button ID="LBpata"  CssClass="butongemi3" OnClick="LBpata_Click" runat="server"  Text='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' ></asp:Button><asp:Label ID="LBLgemiadi5" runat="server" Visible="false" Font-Bold="true" Text='<%#Eval("gemiadi")%>'></asp:Label></td>
                                        <td class="tdis16" id="warntd">
                                            <asp:Label ID="notlar" runat="server" Text='<%#Eval("notlar").ToString().Length>33? (Eval("notlar") as string).Substring(0,34)+"." : Eval("notlar")%>' ToolTip='<%#Eval("notlar") %>'></asp:Label><asp:Label ID="notlar2" runat="server" Text='<%#Eval("notlar")%>' Visible="false"></asp:Label></td>
                                        ...
                                        <td class="tdis15">
                                            ...
                                            <td id="tdlcb"  class ="tdis17">
                                                <asp:Button ID="Lbl20" runat="server" CssClass="butongemi2"  CommandName='<%#Eval("gemiadi")%>' Font-Underline="false"  OnClick="Lbl20_Click"  CommandArgument='<%#Eval("id")%>' Text='<%#Eval("talepno").ToString().Length>6? (Eval("talepno") as string).Substring(0,7)+"." : Eval("talepno")%>'  ToolTip='<%# "Req :" + Eval("talepno") + " / Prq :" + Eval("pratikano") + " / LÇB :" + Eval("lcbno") + " , " + Eval("lcbdest")+ " , " + Eval("lcbdate") %>'></asp:Button><asp:Label ID="Labellcbdate" Visible="false" runat="server" Text='<%#Eval("lcbdate")%>'></asp:Label></td>
                                            <td class ="tdis18">
                                                <asp:ImageButton ID="ImageButtonJobEdit5" CommandName='<%#Eval("gemiadi")%>' CommandArgument='<%#Eval("id")%>' runat="server" ImageUrl="~/images/edit.png" Width="16px" OnClick="ImageButtonJobEdit_Click" />
                                             <asp:Label Font-Size="8px" ID="Lblkaydeden" runat="server" Text='<%#Eval("kaydeden")%>'></asp:Label>
                                            </td>
                            ...
                            <table class="panelpilotata">
                                ...
                                <tr>
                                    <td colspan="2" style="height: 50px; text-align: center; font-size: 20px; font-weight: bold; font-family: 'Trebuchet MS'">
                                        ...
                                        <asp:Button ID="Buttonpilotata" runat="server" CommandName="" Style="height: 30px; Width: 80px;" Text="Nominate" UseSubmitBehavior="false" OnClientClick="this.disabled='true'; this.value='Wait..';" OnClick="Buttonpilotata_Click" />&nbsp;&nbsp; 
                            ...
                            <table class="panelpilotata">
                                <tr>
                                    <td colspan="2">
                                        <div style="border: 1px solid white; font-weight: bold; height: 40px; text-align: center">
                                            <br />
                                            <strong>CONTACTED VESSEL</strong></div>
                                    </td>
                                </tr>
                               <tr>
                                    <td style="text-align: right; width: 50%">Ship Name : </td>
                       ...
                       <asp:Button ID="Buttonpilotatac" runat="server" CommandName="" Style="height: 30px; Width: 120px;" Text="Make Contacted" UseSubmitBehavior="false" OnClientClick="this.disabled='true'; this.value='Wait..';" OnClick="Buttonpilotatac_Click" />&nbsp;&nbsp; 
                       <asp:Button ID="Buttonpilotatacancelc" runat="server" Style="height: 30px; Width: 80px" Text="Cancel" />
                        ...
                        <asp:Panel ID="panelisedit" Style="display: none;" CssClass="panelisedit" runat="server">
                            <div style="margin-top: 10px; clear: both">
                                ...
                                <asp:Button ID="Buttoniseditcancel" BackColor="Red" runat="server" BorderWidth="0"  Style="height: 30px; Width: 80px" Text="Cancel" CssClass="btn" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
...
<td class="panel-style1"><asp:Label  ID="shipnamelcb" runat="server"></asp:Label></td>
</tr>
